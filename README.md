...
| Bariatric Sleeve Gastrectomy Anesthesia | Laparoscopic sleeve gastrectomy, BMI 36.1, ramped airway positioning, pneumoperitoneum, dosing-weight concepts, VTE prevention, PACU recovery | [Open course](bariatric-sleeve-anesthesia-course/index-standalone.html) |
| Orthopedic Anesthesia | Total hip arthroplasty, pelvic / acetabular fracture surgery under neuraxial anesthesia, humerus ORIF under general anesthesia, monitoring and PACU neurovascular checks | [Open course](orthopedic-anesthesia-course/index-standalone.html) |
| Anesthesia-Led Insomnia Care | CBT-I, dexmedetomidine titration, stellate ganglion block, buccal acupuncture, multimodal sleep support, evidence boundaries, and safety monitoring | [Open course](insomnia-anesthesia-course/index-standalone.html) |
| Obsidian + Codex AI Knowledge Base | Local-first AI knowledge base for Cornell students: Obsidian, Markdown, private GitHub sync, source screenshots, and Codex-assisted organization | [Open course](obsidian-ai-knowledge-base-cornell/index.html) |
